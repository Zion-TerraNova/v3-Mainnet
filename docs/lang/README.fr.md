...
Pour une vue d'ensemble complète de l'architecture, des fonctionnalités, de l'historique et de la feuille de route, consultez **[README_FULL.md](../../README_FULL.md)**.

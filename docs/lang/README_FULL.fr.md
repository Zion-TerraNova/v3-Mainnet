...
ZION v3.2.0 One Love est **en ligne et opérationnel** en tant que Mainnet Stable. Le réseau est opérationnel, les blocs sont produits et la chaîne de genèse est établie.
...
**Lancement public officiel : reporté (TBD)**

La période Mainnet Beta dure jusqu'au lancement public officiel, qui est **reporté (TBD)**, selon la feuille de route initiale. Pendant cette période :
...
| Hash de genèse | `96109423298542a836edc10b9ba5ff9b29a1970418db543c2ee5cd952fe35bdb` |
...
| 3.0.6-stable | Lancement public officiel | 📅 reporté (TBD) |
...
- **v3.0.5-beta** (2026-07-10) — Hard genesis reset, contrats DeFi, durcissement de la sécurité, Mainnet Beta
...
| **v3.0.5-beta** | 2026-07-10 | Hard genesis reset, contrats DeFi sur Base, durcissement de la sécurité, divulgations publiques de sécurité, Mainnet Beta. |

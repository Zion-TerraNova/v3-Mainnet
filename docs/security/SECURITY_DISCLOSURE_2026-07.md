...
13. **New genesis hash** — `96109423298542a836edc10b9ba5ff9b29a1970418db543c2ee5cd952fe35bdb`
...
2. **Reproducibility.** The new genesis hash must be independently reproducible. Publishing `genesis.rs` allows anyone to `cargo build` and verify `96109423298542a836edc10b9ba5ff9b29a1970418db543c2ee5cd952fe35bdb`.

 ...
 * Boost stubs
 *
 * The VerusCoin source uses boost::thread_specific_ptr.
 * We replace it with a thin wrapper around thread_local.
 * --------------------------------------------------------------- */
#ifdef __cplusplus
...
namespace boost {
    ...
    public:
        thread_specific_ptr() {}
        ~thread_specific_ptr() { /* thread_local cleaned up automatically */ }
